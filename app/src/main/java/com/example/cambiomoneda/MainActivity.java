        ...
        btnCambio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rbPAE.isChecked()){
                    ...
                    txtResultado.setText(valor + " pesetas " + getResources().getString(R.string.txt_cambio) + " " + resultado + "Euros");
                } else {
                    resultado = valor*166.386;
                    txtResultado.setText(valor + " euros " + getResources().getString(R.string.txt_cambio) + " " + resultado + "Pesetas");
                }
            }
        });
    }
